...
public class MapleMapEffect {
    ...
    public byte[] makeDestroyData(String msg) { //jukebox doesn't REALLY have a destroy, but 0 stops all music
        return jukebox ? CSPacket.playCashSong(0, "") : CField.startMapEffect(msg, 0, true);
    }
