...
public class MapleMapFactory {
    ...
    private static final Logger logger = LogManager.getLogger(MapleMapFactory.class);
 ...
 /*for (int id : GameConstants.unusedNpcs) {
                ...
                map.setCreateMobInterval((short) MapleDataTool.getInt(mapData.getChildByPath("info/createMobInterval"), ServerConfig.createMobInterval));
    ...
    private void addAreaBossSpawn(final MapleMap map) {
        ...
        switch (map.getId()) {
            ...
            case 801030000:
                ...
                monsterid = 9400121;
                msg = "女老板出现了！";
                pos1 = new Point(-214, 95);
                pos2 = new Point(744, 335);
                pos3 = new Point(-1412, 95);
                break;
            default:
                return;
        }
