...
public abstract class Timer {
    ...
    public void start() {
        ...
        file = "logs/Timer/Log_" + name + "_Except.txt";
    ...
    public void stop() {
        try {
            ...
            FileoutputUtil.outputFileError("logs/Timer/Timer.txt", e);
        }
    }
...
public abstract class Timer {
    ...
    public void start() {
        ...
        file = "logs/Timer/Log_" + name + "_Except.txt";
        ses = new ScheduledThreadPoolExecutor(7, new RejectedThreadFactory());
