...
//    private short effect_delay;
    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill) {
        ...
        if (ServerConfig.Monsterstate) {
                ...
                case 112:
                case 152:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [防御增幅]"));
                    break;
                case 131:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [召唤毒雾]"));
                    break;
                case 128:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [诱导]"));
                    break;
                case 103:
                case 113:
                case 153:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [魔法防御增幅]"));
                    break;
                case 110:
                case 150:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [物理攻击增幅]"));
                    break;
                case 101:
                case 111:
                case 151:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [魔法攻击增幅]"));
                    break;
                case 120:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat(""  + monster.stats.getName() + " 使用技能 [封印]"));
                    break;
                case 121:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [黑暗]"));
                    break;
                case 122:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [弱化]"));
                    break;
                case 124:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [诅咒]"));
                    break;
                case 114:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [治愈]"));
                    break;
                case 140:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [物理无效]"));
                    break;
                case 141:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [魔法无效]"));
                    break;
                case 200:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 [召唤小弟]"));
                    break;
                default:
                    monster.getMap().broadcastMessage(CWvsContext.yellowChat("" + monster.stats.getName() + " 使用技能 " + skillId));
                    break;
            }
        }
        switch (skillId) {
