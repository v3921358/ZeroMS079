...
public class DumpQuests {
    ...
    protected int id = 0;
    private static final Logger logger = LogManager.getLogger(DumpQuests.class);

    public DumpQuests(boolean update) throws Exception {
        this.update = update;
        this.quest = MapleDataProviderFactory.getDataProvider(new File((System.getProperty("wzpath") != null ? System.getProperty("wzpath") : "") + "wz/Quest.wz"));
        if (quest == null) {
            hadError = true;
        }
    }
