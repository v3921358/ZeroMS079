...
public class DumpItems {
    ...
    protected int id = 0;
    private static final Logger logger = LogManager.getLogger(DumpItems.class);
    ...
    public void dumpItem(PreparedStatement psa, PreparedStatement psr, PreparedStatement ps, PreparedStatement pse, MapleData iz) throws Exception {
        try {
            ...
            FileoutputUtil.outputFileError(FileoutputUtil.Exception_Log, nfe);
                ...
                for (MapleData data : info) {
                    if (data.getName().length() > 3) {
                        try {
                            ...
                            FileoutputUtil.log(FileoutputUtil.Exception_Log, "id:" + id + "\r\n" + e);
