...
public class MapleAESOFB {
    ...
    private static final Logger logger = LogManager.getLogger(MapleAESOFB.class);
 ...
 (byte) 0xB4, 0x00, 0x00, 0x00, 
    ...
    public MapleAESOFB(byte iv[], short mapleVersion) {
        try {
            ...
            System.err.println("Error initalizing the encryption cipher. Make sure you're using the Java Cryptography Extension (JCE) Unlimited Strength Jurisdiction Policy Files." + e);
        }
    ...
    public static byte[] getNewIv(byte oldIv[]) {
        byte a = ServerConfig.USE_FIXED_IV ? (byte) 0x11 : (byte) 0xf2;
        byte b = ServerConfig.USE_FIXED_IV ? (byte) 0x22 : (byte) 0x53;
        byte c = ServerConfig.USE_FIXED_IV ? (byte) 0x33 : (byte) 0x50;
        byte d = ServerConfig.USE_FIXED_IV ? (byte) 0x44 : (byte) 0xc6;
        byte[] in = {a, b, c, d}; // magic
