...
public class InventoryHandler {
    ...
    public static final void ItemMove(final LittleEndianAccessor slea, final MapleClient c) {
        ...
        final short src = slea.readShort();//背包位置
        final short dst = slea.readShort();//装备栏位置
    ...
    public static boolean UseRewardItem(byte slot, int itemId, final boolean unseal, final MapleClient c, final MapleCharacter chr) {
        ...
        if (toUse != null && toUse.getQuantity() >= 1 && toUse.getItemId() == itemId && !chr.hasBlockedInventory()) {
            if (chr.getInventory(MapleInventoryType.EQUIP).getNextFreeSlot() > -1 && chr.getInventory(MapleInventoryType.USE).getNextFreeSlot() > -1 && chr.getInventory(MapleInventoryType.SETUP).getNextFreeSlot() > -1 && chr.getInventory(MapleInventoryType.ETC).getNextFreeSlot() > -1) {
                List<Integer> gift = new java.util.ArrayList();
                switch (itemId) {
                    case 2022570:
                        gift.add(1302119);
                        gift.add(1312045);
                    ...
                    case 2022613:
                        ...
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900007, 88);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
                    ...
                    case 2022614:
                        ...
                        NPCScriptManager.getInstance().dispose(c);
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900007, 188);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
                    ...
                    case 2022428:
                        ...
                        NPCScriptManager.getInstance().dispose(c);
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900003, 2022428);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
                    ...
                    case 2022468:
                        ...
                        NPCScriptManager.getInstance().dispose(c);
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900003, 2022429);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
                    ...
                    case 2550014:
                        ...
                        NPCScriptManager.getInstance().dispose(c);
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900003, 2550014);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
                    ...
                    case 2022615:
                        ...
                        NPCScriptManager.getInstance().dispose(c);
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900003, 2022615);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
                    ...
                    case 2022336:
                        ...
                        NPCScriptManager.getInstance().dispose(c);
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900003, 2022336);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
                    ...
                    case 2022550:
                        ...
                        NPCScriptManager.getInstance().dispose(c);
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900003, 2022550);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
                    ...
                    case 2022552:
                        ...
                        NPCScriptManager.getInstance().dispose(c);
                        c.getSession().write(CWvsContext.enableActions());
                        NPCScriptManager.getInstance().start(c, 9900003, 2022552);
                        if (!gift.isEmpty()) {
                            int rand = java.util.concurrent.ThreadLocalRandom.current().nextInt(gift.size());
                            MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, (short) slot, (short) 1, false);
                            MapleInventoryManipulator.addById(c, (gift.get(rand)), (short) 1, "");
    ...
    public static void UseCatchItem(final LittleEndianAccessor slea, final MapleClient c, final MapleCharacter chr) {
        ...
        if (toUse != null && toUse.getQuantity() > 0 && toUse.getItemId() == itemid && mob != null && !chr.hasBlockedInventory() && itemid / 10000 == 227 && MapleItemInformationProvider.getInstance().getCardMobId(itemid) == mob.getId()) {
            if (!MapleItemInformationProvider.getInstance().isMobHP(itemid) || mob.getHp() <= mob.getMobMaxHp() / 2) {
                map.broadcastMessage(MobPacket.catchMonster(mob.getId(), itemid, (byte) 1));
                ...
                map.broadcastMessage(MobPacket.catchMonster(mob.getId(), itemid, (byte) 0));
        ...
        switch (mod) {
            case 0:
                if (chr.getInventory(MapleInventoryType.CASH).countById(keyIDforRemoval) > 0) {
                    ...
                    NPCScriptManager.getInstance().dispose(c);
                    c.getSession().write(CWvsContext.enableActions());
                    NPCScriptManager.getInstance().start(c, 9010000, box);
                } else {
                ...
                break;
            case 1:
                if (chr.getCSPoints(2) >= 800) {
                    MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.ETC, (byte) slot, (short) 1, true);
                    chr.modifyCSPoints(2, -800);
                    c.removeClickedNPC();
                    NPCScriptManager.getInstance().dispose(c);
                    c.getSession().write(CWvsContext.enableActions());
                    NPCScriptManager.getInstance().start(c, 9010000, box);
                } else {
                    chr.dropMessage(5, "请确认是否有800抵用卷。");
                    c.getSession().write(CWvsContext.enableActions());
                }
                break;
            default:
    ...
    public static final void UseCashItem(final LittleEndianAccessor slea, final MapleClient c) {
        ...
        switch (itemId) {
            ...
            case 5152107: {
                if ((itemId >= 5152100) && (itemId <= 5152107)) {
                    if (c.getPlayer().getLevel() < 30) {
                        c.getPlayer().dropMessage(1, "必须30级以上才能使用。");
                        break;
                    }
                    int color = (itemId - 5152100) * 100;
                    if (color >= 0) {
                        if (c.getPlayer().getFace() % 1000 < 100) {
                            color += c.getPlayer().getFace();
                        } else if ((c.getPlayer().getFace() % 1000 >= 100) && (c.getPlayer().getFace() % 1000 < 200)) {
                            color += c.getPlayer().getFace() - 100;
                        } else if ((c.getPlayer().getFace() % 1000 >= 200) && (c.getPlayer().getFace() % 1000 < 300)) {
                            color += c.getPlayer().getFace() - 200;
                        } else if ((c.getPlayer().getFace() % 1000 >= 300) && (c.getPlayer().getFace() % 1000 < 400)) {
                            color += c.getPlayer().getFace() - 300;
                        } else if ((c.getPlayer().getFace() % 1000 >= 400) && (c.getPlayer().getFace() % 1000 < 500)) {
                            color += c.getPlayer().getFace() - 400;
                        } else if ((c.getPlayer().getFace() % 1000 >= 500) && (c.getPlayer().getFace() % 1000 < 600)) {
                            color += c.getPlayer().getFace() - 500;
                        } else if ((c.getPlayer().getFace() % 1000 >= 600) && (c.getPlayer().getFace() % 1000 < 700)) {
                            color += c.getPlayer().getFace() - 600;
                        } else if ((c.getPlayer().getFace() % 1000 >= 700) && (c.getPlayer().getFace() % 1000 < 800)) {
                            color += c.getPlayer().getFace() - 700;
                        }
                        c.getPlayer().setFace(color);
                        c.getPlayer().updateSingleStat(MapleStat.FACE, c.getPlayer().getFace());
                        c.getPlayer().equipChanged();
                        used = true;

                    } else {
                        c.getPlayer().dropMessage(1, "使用一次性眼镜错误发生错误。");
                    }
                }
                break;
            }
            ...
            case 5050000: { // AP Reset
                ...
                switch (apto) { // AP to
                    ...
                    case LUK: // luk
                        ...
                        break;
                    case MAXHP: // hp
                        if (playerst.getMaxHp() >= StatsHandling.hpMpLimit) {
                            used = false;
                        }
                        break;
                    case MAXMP: // mp
                        if (playerst.getMaxMp() >= StatsHandling.hpMpLimit) {
                            used = false;
                        }
                        break;
                }
                switch (apfrom) { // AP to
                    ...
                    case LUK: // luk
                        ...
                        break;
                    case MAXHP: // hp
                        if (/*playerst.getMaxMp() < ((c.getPlayer().getLevel() * 14) + 134) || */c.getPlayer().getHpApUsed() <= 0 || c.getPlayer().getHpApUsed() >= 10000 || playerst.getMaxHp() <= 50) {
                            used = false;
                            c.getPlayer().dropMessage(1, "你需要 HP 或 MP 以便采取点.");
                        }
                        break;
                    case MAXMP: // mp
                        if (/*playerst.getMaxMp() < ((c.getPlayer().getLevel() * 14) + 134) || */c.getPlayer().getHpApUsed() <= 0 || c.getPlayer().getHpApUsed() >= 10000 || playerst.getMaxMp() <= 50) {
                            used = false;
                            c.getPlayer().dropMessage(1, "你需要 HP 或  MP 以便采取点.");
                        }
                        break;
                    ...
                    switch (apto) { // AP to
                        ...
                        case MAXHP: // hp
                            ...
                            if (GameConstants.isBeginnerJob(job)) { // Beginner
                                ...
                                Skill improvingMaxHP1 = SkillFactory.getSkill(11000000);
                                ...
                                Skill improvingMaxHP1 = SkillFactory.getSkill(15100000);
                                int improvingMaxHPLevel1 = c.getPlayer().getSkillLevel(improvingMaxHP1);
                                if (improvingMaxHPLevel1 >= 1) {
                                    maxhp += improvingMaxHP1.getEffect(improvingMaxHPLevel1).getY();
                                }
                        ...
                        case MAXMP: // mp
                            ...
                            if (GameConstants.isBeginnerJob(job)) { // Beginner
                                ...
                                Skill improvingMaxMP1 = SkillFactory.getSkill(12000000);
                    ...
                    switch (apfrom) { // AP from
                        ...
                        case MAXHP: // HP
                            ...
                            if (playerst.getHp() > playerst.getMaxHp()) {
                                playerst.setHp(maxhp, c.getPlayer());
                            }
                            playerst.setMaxHp(maxhp, c.getPlayer());
                            statupdate.put(MapleStat.MAXHP, (long) maxhp);
                            statupdate.put(MapleStat.HP, (long) playerst.getHp());
                        ...
                        case MAXMP: // MP
                            ...
                            if (playerst.getMp() > playerst.getMaxMp()) {
                                playerst.setMp(maxmp, c.getPlayer());
                            }
                            playerst.setMaxMp(maxmp, c.getPlayer());
                            statupdate.put(MapleStat.MAXMP, (long) maxmp);
                            statupdate.put(MapleStat.MP, (long) playerst.getMp());
            ...
            case 5520000: { // Karma
                ...
                if (item != null && !ItemFlag.KARMA_EQ.check(item.getFlag()) && !ItemFlag.KARMA_USE.check(item.getFlag())/*&& GameConstants.isEquip(item.getItemId()) && ((Equip) item).getKarmaCount() != 0*/) {
                    //Equip eq = (Equip) item;
                    if ((itemId == 5520000 && MapleItemInformationProvider.getInstance().isKarmaEnabled(item.getItemId())) || (itemId == 5520000 && MapleItemInformationProvider.getInstance().isPKarmaEnabled(item.getItemId())) || (itemId == 5520001 && MapleItemInformationProvider.getInstance().isPKarmaEnabled(item.getItemId()))) {
                        short flag = item.getFlag();
                        if (ItemFlag.UNTRADABLE.check(flag)) {
                            flag -= ItemFlag.UNTRADABLE.getValue();
                        } else if (type == MapleInventoryType.EQUIP) {
            ...
            case 5070000: { // Megaphone
                   if (!ServerConfig.Gamehorn) {
                    c.getPlayer().dropMessage(1, "目前喇叭功能从后台关闭了，无法广播喇叭");
                    break;
                }
                if (c.getPlayer().getLevel() < 10) {
                    c.getPlayer().dropMessage(5, "需要等级10级才能使用这个道具。");
                    break;
                }

                if (!c.getPlayer().getCheatTracker().canSmega()) {
                    c.getPlayer().dropMessage(5, "你需要等待3秒之后才能使用这个道具。");
                    break;
                }
                if (!c.getChannelServer().getMegaphoneMuteState()) {
                    ...
                    if (ServerConfig.logs_chat) {
                        FileoutputUtil.logToFile("logs/聊天/喇叭頻道.txt", "\r\n " + FileoutputUtil.NowTime() + " IP: " + c.getSessionIPAddress() + " 玩家『" + c.getPlayer().getName() + "』频道『" + c.getChannel() + "』喇叭道具『" + itemId + "』：" + message);
                    }
                    used = true;
                } else {
            ...
            case 5077000: { // 3 line Megaphone
                ...
                if (!c.getChannelServer().getMegaphoneMuteState()) {
                    ...
                    if (ServerConfig.logs_chat) {
                        //FileoutputUtil.logToFile("logs/聊天/喇叭頻道.txt", "\r\n " + FileoutputUtil.NowTime() + " IP: " + c.getSessionIPAddress() + " 玩家『" + c.getPlayer().getName() + "』频道『" + c.getChannel() + "』喇叭道具『" + itemId + "』：" + messages);
                    }
                    used = true;
                } else {
                    c.getPlayer().dropMessage(5, "The usage of Megaphone is currently disabled.");
            ...
            case 5074000: { // Skull Megaphone
                ...
                if (!c.getChannelServer().getMegaphoneMuteState()) {
                    ...
                    World.Broadcast.broadcastSmega(CWvsContext.broadcastMsg(13, c.getChannel(), sb.toString(), ear));
                    if (ServerConfig.logs_chat) {
                        FileoutputUtil.logToFile("logs/聊天/喇叭頻道.txt", "\r\n " + FileoutputUtil.NowTime() + " IP: " + c.getSessionIPAddress() + " 玩家『" + c.getPlayer().getName() + "』频道『" + c.getChannel() + "』喇叭道具『" + itemId + "』：" + message);
                    }
                    used = true;
            ...
            case 5075002: { // MapleTV Heart Messenger
                ...
                //slea.readInt();
                if (megassenger) {
                    World.Broadcast.broadcastSmega(CWvsContext.broadcastMsg(3, c.getChannel(), c.getPlayer().getName() + " : " + builder.toString(), ear));
                }
                if (!MapleTVEffect.isActive()) {
                    MapleTVEffect mapleTVEffect = new MapleTVEffect(c.getPlayer(), victim, messages, tvType);
                    used = true;
                } else {
                    c.getPlayer().dropMessage(1, "有人正在使用TV喇叭。");
                    return;
                }
            ...
            case 5240028: { // Pet food
                ...
                if (pet.getCloseness() < 30000) {
                    ...
                    //    pet.setCloseness(pet.getCloseness() + (100 * c.getChannelServer().getTraitRate()));//宠物亲密度
                        pet.setCloseness(pet.getCloseness() + (1 * c.getChannelServer().getPetRate()));//宠物经验
                    }
                    ...
                    if (e.isRunning()) {
                        for (int i : e.getType().mapids) {
                            if (c.getPlayer().getMapId() == i) {
                                c.getPlayer().dropMessage(5, "你不能在这里使用它。");
                                c.getSession().write(CWvsContext.enableActions());
                                return;
                            }
                        }
            ...
            case 5390009: {
                ...
                if (!c.getPlayer().getCheatTracker().canAvatarSmega()) {
                    c.getPlayer().dropMessage(5, "你需要等待5秒之后才能使用这个道具。");
                    break;
                }
                if (!c.getChannelServer().getMegaphoneMuteState()) {
                    ...
                    final boolean ear = slea.readByte() != 0;
                    World.Broadcast.broadcastSmega(CWvsContext.getAvatarMega(c.getPlayer(), c.getChannel(), itemId, sb.toString(), ear));
                    used = true;
                } else {
                    c.getPlayer().dropMessage(5, "扩音器使用当前被禁用.");
                }
    ...
    public static final void Pickup_Player(final LittleEndianAccessor slea, MapleClient c, final MapleCharacter chr) {
        ...
        try {
            ...
            if (Distance > 5000 && (mapitem.getMeso() > 0 || mapitem.getItemId() != 4001025)) {
              //  World.Broadcast.broadcastGMMessage(CWvsContext.broadcastMsg(6, "[系统警告] " + chr.getName() + " (等级 " + chr.getLevel() + ") " + "疑似吸物。 "));
...
//                System.err.println("Return 4");
            ...
            final double Distance = Client_Reportedpos.distanceSq(mapitem.getPosition());
            final double Distances = pet.getPos().distanceSq(mapitem.getPosition());
            if (Distance == 0 || Distances == 0) {
               // World.Broadcast.broadcastGMMessage(CWvsContext.broadcastMsg(6, "[系统警告] " + chr.getName() + " (等级 " + chr.getLevel() + ") " + "疑似宠物吸物。 "));
            }
...
//            System.err.println("Petdrop 5");
            if (mapitem.getMeso() > 0) {
                if (chr.getParty() != null && mapitem.getOwner() != chr.getId()) {
                    ...
                    for (final MapleCharacter m : toGive) {
                        m.gainMeso(splitMeso / toGive.size(), true, false, false);
                    }
