...
public class LoginInformationProvider {
    ...
    public enum JobType {
        ...
        Resistance(-1, 3000, 931000000, false, false, false, false, false, false, false, false),
        Cygnus(0, 1000, 913040000, false, false, false, false, false, true, false, false),
        Adventurer(1, 0, ServerConfig.BEGINNER_SPAWN_MAP, false, true, false, false, false, false, false, false),
        Aran(2, 2000, 914000000, false, false, false, false, true, false, false, false),
        Evan(4, 2001, 900010000, false, false, false, false, true, false, false, false),//evan starter map - need to test tutorial
        ...
        Phantom(7, 2003, 915000000, false, false, false, false, false, true, false, false),
        DualBlade(8, 0, 103050900, false, false, false, false, true, false, false, false),
        Mihile(9, 5000, 913070000, false, false, false, false, true, false, false, false),
        Luminous(10, 2004, 101000000, false, false, false, false, false, true, false, false),//Ellinia atm TODO tutorial
        Kaiser(11, 6000, 0, false, false, false, false, false, false, false, false),
        AngelicBuster(12, 6001, 940011000, false, false, false, false, false, false, false, false),//400000000 - 940011000 - town now TODO tutorial
        Cannoneer(13, 0, 0, false, false, false, false, true, false, false, false),
        Xenon(14, 3002, 931050920, false, false, true, false, false, false, false, false),
    ...
    protected LoginInformationProvider() {
        System.out.println("【" + CurrentReadable_Time() + "】【信息】WZ內禁止使用的名称");
        ...
        for (MapleData dat : infoData) {
            try {
                ...
                for (MapleData d : dat) {
                    Triple<Integer, Integer, Integer> key = new Triple<>(gender, Integer.parseInt(d.getName()), type);
