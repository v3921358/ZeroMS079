...
public class MapleParty implements Serializable {
    ...
    */
    ...
    public static int 捉鬼任务线程 = 0;
    public static int 捉鬼任务 = 0;
    public static int 捉鬼任务频道 = 0;
    public static int 捉鬼任务地图 = 10000;
    public static int 捉鬼任务坐标X = 0;
    public static int 捉鬼任务坐标Y = 0;
    public static int 捉鬼任务时间 = 0;
