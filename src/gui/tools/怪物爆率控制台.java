    ...
    public void 刷新世界爆物() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                世界爆物.getColumnModel().getColumn(4).setCellRenderer(new MyTableCellRendererGoods());
            }
    ...
    public void 刷新怪物爆物() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                怪物爆物.getColumnModel().getColumn(5).setCellRenderer(new MyTableCellRendererGoods());
            }
        } catch (SQLException ex) {
            Logger.getLogger(Start.class.getName()).log(Level.SEVERE, null, ex);
        }
