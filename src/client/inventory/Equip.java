...
public class Equip extends Item implements Serializable {
    ...
    public int 取孔位状态(int 几号孔位) {//未打孔 = -1，已打孔 = 0，已镶嵌 = 宝石物品ID
        几号孔位 -= 1;
        if (几号孔位 < 0 || 几号孔位 > 11) {
            几号孔位 = 0;
        }
    ...
    public void 置孔位状态(int 几号孔位,int 状态) {
        几号孔位 -= 1;
        if (几号孔位 < 0 || 几号孔位 > 11) {
            几号孔位 = 0;
        }
